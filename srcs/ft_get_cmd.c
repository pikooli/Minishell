...
/*   Updated: 2020/01/12 14:26:43 by mpouzol          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_cmd_take(t_cmd cmd, char buf[4])
{
	while (1)
	{
		if (!cmd.str)
		...
		buf[0] == '\'' && cmd.dquote == 1 ? cmd.quote *= -1 : 0;
		buf[0] == '\"' && cmd.quote == 1 ? cmd.dquote *= -1 : 0;
		if (buf[0] == 10 && cmd.quote == 1 && cmd.dquote == 1)
		{
